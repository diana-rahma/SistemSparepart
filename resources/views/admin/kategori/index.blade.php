...
<div class="app-content-header">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-6">
        <h3 class="mb-0"><i class="bi bi-tags-fill text-primary me-2"></i>Kelola Kategori</h3>
      </div>
      <div class="col-sm-6">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2 py-3">
        <div class="d-flex align-items-center gap-2">
          <h3 class="card-title fw-bold m-0">Daftar Kategori</h3>
        </div>
        ...
        <div class="d-flex align-items-center gap-2">
          <form action="{{ route('admin.kategori.index') }}" method="GET" class="d-flex gap-2">
            <div class="input-group input-group-sm" style="width: 220px;">
              ...
              @if(request('search'))
                <a href="{{ route('admin.kategori.index') }}" class="btn btn-outline-danger" title="Reset Reset Filter">
          ...
          <a href="{{ route('admin.kategori.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-1">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group btn-group-sm" role="group">
                      <a href="{{ route('admin.kategori.edit', $item->id) }}" class="btn btn-outline-warning" title="Edit Kategori">
                        <i class="bi bi-pencil-square"></i>
                      </a>
                      <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $item->id }}" title="Hapus Kategori">
              ...
              @empty
                <tr>
                  <td colspan="6" class="text-center py-4 text-muted">
                    ...
                    Belum ada data kategori. Klik tombol <strong>Tambah Kategori</strong> untuk menambahkan.
                  </td>
                </tr>
              @endforelse
            </tbody>
